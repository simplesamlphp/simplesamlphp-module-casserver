...
class sspmod_sbcasserver_Auth_Process_UserRegistryAttributes extends SimpleSAML_Auth_ProcessingFilter {
  ...
  public function process(&$request) {
    ...
    } else if($userRegistryAttributesResponse->serviceStatus == 'SystemError') {
      SimpleSAML_Logger::error('UserRegistryAttributes: look up of user ' . var_export($username, TRUE) . ' failed with status '.var_export($userRegistryAttributesResponse->serviceStatus).'.');
    }
  }
